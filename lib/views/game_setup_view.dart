...
/// The game-options setup screen that was previously the full MainMenuView.
/// Pushed as a page from HomeView via CupertinoPageRoute.
class GameSetupView extends StatefulWidget {
  const GameSetupView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<AppModel, AppTheme>(
      ...
      builder: (context, theme, child) {
        ...
        final iconColor =
            isDarkBg ? const Color(0xFFC3C8C2) : const Color(0xFF313030);
            ...
            child: Stack(
              children: [
                ...
                SafeArea(
                  ...
                  child: Column(
                    children: [
                      // Glassy header with back button
                      Padding(
